# Detailed Technical Guide — ASUS VivoBook 14 X1407QA

> This document preserves the complete implementation history, installation
> notes, hardware research, and fix-by-fix guide from the original README.
> Start with the concise [project overview](../README.md) for the current state
> and latest ISO.
...
Type-C ports, and both advertise Thunderbolt SVID `8087` locally. The live SoC
is X1P42100/**Purwa** (not Hamoa), inheriting the X1E USB blocks through
`purwa.dtsi`. Plain USB-C/DP works; the missing function is tunneling.
...
Its `0x9f70`-byte container has SHA-256
...
- **USB4/TB3 dock tunneling:** blocked — firmware and hardware resources are now
  known, but the Qualcomm HR driver and complete DT contract are not public. The
  Elgato TB3 Dock stays unusable because it routes *everything* through the tunnel
- **Not worth doing yet:** enabling `CONFIG_USB4`, applying only the PHY v4, or
  inventing an HR overlay; none supplies the missing platform probe
- **Reopen trigger:** a Qualcomm object in `drivers/thunderbolt/Makefile` plus a
  matching binding/DT series. Installing that stack will require a reboot; there
  is no reason to reboot for USB4 before it exists

Documents:

- [USB4-TB3-investigation.md](../USB4-TB3-investigation.md)
- [docs/research/2026-03-24-usb4-custom-kernel-plan.md](research/2026-03-24-usb4-custom-kernel-plan.md)
- [docs/research/2026-03-24-usb4-upstream-patch-checklist.md](research/2026-03-24-usb4-upstream-patch-checklist.md)
...
> [docs/GUIA-EXTRAIR-FIRMWARE.md](GUIA-EXTRAIR-FIRMWARE.md).
...
Detailed bring-up log and timestamps: [docs/research/2026-03-24-rgb-camera-progress.md](research/2026-03-24-rgb-camera-progress.md)
...
Historical 6.19.8 diff: [docs/research/qcom-camss-x1e80100-cpas-ahb-fix.patch](research/qcom-camss-x1e80100-cpas-ahb-fix.patch)
...
[`docs/GUIA-POS-INSTALACAO.md`](GUIA-POS-INSTALACAO.md).
