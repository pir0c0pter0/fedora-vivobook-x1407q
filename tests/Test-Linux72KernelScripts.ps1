...
foreach ($token in 'file','ARM64','modules.dep','x1p42100-asus-zenbook-a14','7.2.0-x1407qa','CONFIG_ISO9660_FS=y','CONFIG_EROFS_FS=y','CONFIG_EROFS_FS_ZIP=y','CONFIG_DM_SNAPSHOT=m','sha256sum') {
