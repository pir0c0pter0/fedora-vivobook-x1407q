...
- **Estado global atual** — `systemd-analyze` = 1min36.997s (câmera = 3.415s, regressão restante separada). O firewall foi corrigido no kernel 7.2 com nftables + helper conntrack NetBIOS e validado `active/running` em 2026-08-24; não restaurar o config sem esses módulos.
